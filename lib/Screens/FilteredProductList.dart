...
class FilteredProductsList extends StatefulWidget {
  ...
  FilteredProductsList({this.title, this.togfav, this.brand, this.catName});
...
class _FilteredProductsListState extends State<FilteredProductsList> {
  ...
  void didChangeDependencies() {
    if (widget.catName != null) {
      allproductlist =
          Provider.of<ProductData>(context).prodListByCateg(widget.catName);
  ...
  Widget build(BuildContext context) {
    List<int> ints = List<int>.generate(5, (i) => i * 12);
